...
function renderRightDocList(filename) {
    ...
    var strDocList = '<div class="toc">' +
        ...
        '<ul>' +
        '<li><span class="section"><a href="documents-indices.html">Data in: documents and indices</a></span></li>' +
        '<li><span class="section"><a href="search-analyze.html">Information out: search and analyze</a></span></li>' +
        '<li><span class="section"><a href="scalability.html">Scalability and resilience</a></span></li>' +
        '</ul>' +
        '</li>' +
        '<li><span class="chapter"><a href="release-highlights.html">What’s new in 7.7</a></span></li>' +
        '<li class="collapsible"><span class="part"><a href="getting-started.html">Getting started with Elasticsearch</a></span>' +
        '<ul>' +
        '<li><span class="chapter"><a href="getting-started-install.html">Get Elasticsearch up and running</a></span></li>' +
        '<li><span class="chapter"><a href="getting-started-index.html">Index some documents</a></span></li>' +
        '<li><span class="chapter"><a href="getting-started-search.html">Start searching</a></span></li>' +
        '<li><span class="chapter"><a href="getting-started-aggregations.html">Analyze results with aggregations</a></span></li>' +
        '<li><span class="chapter"><a href="getting-started-next-steps.html">Where to go from here</a></span></li>' +
        '</ul>' +
        '</li>' +
        ...
        '<ul>' +
        '<li><span class="section"><a href="targz.html">Install Elasticsearch from archive on Linux or MacOS</a></span></li>' +
        '<li><span class="section"><a href="zip-windows.html">Install Elasticsearch with <code class="literal">.zip</code> on Windows</a></span></li>' +
        '<li><span class="section"><a href="deb.html">Install Elasticsearch with Debian Package</a></span></li>' +
        '<li><span class="section"><a href="rpm.html">Install Elasticsearch with RPM</a></span></li>' +
        '<li><span class="section"><a href="windows.html">Install Elasticsearch with Windows MSI Installer</a></span></li>' +
        '<li><span class="section"><a href="docker.html">Install Elasticsearch with Docker</a></span></li>' +
        '<li><span class="section"><a href="brew.html">Install Elasticsearch on macOS with Homebrew</a></span></li>' +
        '</ul>' +
        '</li>' +
        '<li class="collapsible"><span class="chapter"><a href="settings.html">Configuring Elasticsearch</a></span>' +
        '<ul>' +
        '<li><span class="section"><a href="jvm-options.html">Setting JVM options</a></span></li>' +
        '<li><span class="section"><a href="secure-settings.html">Secure settings</a></span></li>' +
        '<li><span class="section"><a href="auditing-settings.html">Auditing settings</a></span></li>' +
        '<li><span class="section"><a href="circuit-breaker.html">Circuit breaker settings</a></span></li>' +
        '<li><span class="section"><a href="modules-cluster.html">Cluster-level shard allocation and routing settings</a></span></li>' +
        '<li><span class="section"><a href="ccr-settings.html">Cross-cluster replication settings</a></span></li>' +
        '<li><span class="section"><a href="modules-discovery-settings.html">Discovery and cluster formation settings</a></span></li>' +
        '<li><span class="section"><a href="modules-fielddata.html">Field data cache settings</a></span></li>' +
        '<li><span class="section"><a href="modules-http.html">HTTP</a></span></li>' +
        '<li><span class="section"><a href="ilm-settings.html">Index lifecycle management settings</a></span></li>' +
        '<li><span class="section"><a href="recovery.html">Index recovery settings</a></span></li>' +
        '<li><span class="section"><a href="indexing-buffer.html">Indexing buffer settings</a></span></li>' +
        '<li><span class="section"><a href="license-settings.html">License settings</a></span></li>' +
        '<li><span class="section"><a href="modules-gateway.html">Local gateway settings</a></span></li>' +
        '<li><span class="section"><a href="logging.html">Logging configuration</a></span></li>' +
        '<li><span class="section"><a href="ml-settings.html">Machine learning settings</a></span></li>' +
        '<li><span class="section"><a href="monitoring-settings.html">Monitoring settings</a></span></li>' +
        '<li><span class="section"><a href="modules-node.html">Node</a></span></li>' +
        '<li><span class="section"><a href="modules-network.html">Network settings</a></span></li>' +
        '<li><span class="section"><a href="query-cache.html">Node query cache settings</a></span></li>' +
        '<li><span class="section"><a href="search-settings.html">Search settings</a></span></li>' +
        '<li><span class="section"><a href="security-settings.html">Security settings</a></span></li>' +
        '<li><span class="section"><a href="shard-request-cache.html">Shard request cache settings</a></span></li>' +
        '<li><span class="section"><a href="slm-settings.html">Snapshot lifecycle management settings</a></span></li>' +
        '<li><span class="section"><a href="sql-settings.html">SQL access settings</a></span></li>' +
        '<li><span class="section"><a href="transform-settings.html">Transforms settings</a></span></li>' +
        '<li><span class="section"><a href="modules-transport.html">Transport</a></span></li>' +
        '<li><span class="section"><a href="modules-threadpool.html">Thread pools</a></span></li>' +
        '<li><span class="section"><a href="notification-settings.html">Watcher settings</a></span></li>' +
        '</ul>' +
        '</li>' +
        '<li class="collapsible"><span class="chapter"><a href="important-settings.html">Important Elasticsearch configuration</a></span>' +
        '<ul>' +
        '<li><span class="section"><a href="path-settings.html"><code class="literal">path.data</code> and <code class="literal">path.logs</code></a></span></li>' +
        '<li><span class="section"><a href="cluster.name.html"><code class="literal">cluster.name</code></a></span></li>' +
        '<li><span class="section"><a href="node.name.html"><code class="literal">node.name</code></a></span></li>' +
        '<li><span class="section"><a href="network.host.html"><code class="literal">network.host</code></a></span></li>' +
        '<li><span class="section"><a href="discovery-settings.html">Discovery and cluster formation settings</a></span></li>' +
        '<li><span class="section"><a href="heap-size.html">Setting the heap size</a></span></li>' +
        '<li><span class="section"><a href="heap-dump-path.html">JVM heap dump path</a></span></li>' +
        '<li><span class="section"><a href="gc-logging.html">GC logging</a></span></li>' +
        '<li><span class="section"><a href="es-tmpdir.html">Temp directory</a></span></li>' +
        '<li><span class="section"><a href="error-file-path.html">JVM fatal error logs</a></span></li>' +
        '</ul>' +
        '</li>' +
